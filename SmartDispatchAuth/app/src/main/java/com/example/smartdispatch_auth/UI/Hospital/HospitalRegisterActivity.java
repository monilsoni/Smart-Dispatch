                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            newUserRef.set(requester).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if(task.isSuccessful()) {
                                        ...
                                        Intent intent = new Intent(com.example.smartdispatch_auth.UI.Requester.RegisterActivity.this, LoginActivity.class);
                                        intent.putExtra("authenticator", "requester");
                                        startActivity(intent);
                                        finish();
                                    }else if(task.getException() != null){
                                        Toast.makeText(com.example.smartdispatch_auth.UI.Requester.RegisterActivity.this, "Registration Failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }else{
                                        Toast.makeText(com.example.smartdispatch_auth.UI.Requester.RegisterActivity.this, "Something went wrong: FireStore", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                            ...
                            Toast.makeText(com.example.smartdispatch_auth.UI.Requester.RegisterActivity.this, "Something went wrong with registration.", Toast.LENGTH_SHORT).show();
                        }
            ...
            case R.id.btn_register:{
                ...
                if(!isEmpty(email)
                    ...
                    if(mPassword.getText().toString().equals(mConfirmPassword.getText().toString())){
                        ...
                        Toast.makeText(this, "Hello There: Beginning the registration", Toast.LENGTH_SHORT).show();
