...
public class AdminCurrentRequest extends AppCompatActivity {

    private static final String TAG = "AdminCurrentRequest";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_current_request);
